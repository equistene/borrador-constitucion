...
export default function Home() {
  return (
    <div>
      <Head>
        <title>UN CHILE INCLUSIVO | Guía Práctica Borrador - Nueva Constitución</title>
      ...
      <section className="pilar">
        <div className="container">
          ...
          <p><strong>Derechos de las personas mayores.</strong> Las personas tienen derecho a envejecer con dignidad, libres de maltrato, y a contar con prestaciones de seguridad social para una vejez digna. Además, reconoce su participación política y social, y el derecho de accesibilidad al entorno físico, económico, cultural y digital.</p>

          <p><strong>Derechos de las personas con discapacidad.</strong> Se reconoce que las personas con discapacidad tienen derecho a la accesibilidad universal, la inclusión social, su inserción laboral, y participación política, económica, social y cultural.</p>
          ...
          <p><strong>Chile es un Estado plurinacional e intercultural.</strong> Se reconoce la coexistencia de diversas naciones y pueblos en el marco de la unidad e indivisibilidad del Estado. Todas las identidades y culturas son respetadas, regidas bajo la misma Constitución y los poderes del Estado establecidos en ella.</p>
          ...
          <p><strong>Emblemas nacionales.</strong> Son símbolos que nos identifican como país. Son emblemas nacionales de Chile la bandera, el escudo y el himno nacional. Además, el Estado reconocerá los símbolos y emblemas de los distintos pueblos indígenas.</p>
        </div>
      </section>
