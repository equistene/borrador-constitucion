...
export default function Home() {
  return (
    <div>
      <Head>
        <title>UN CHILE LIBRE | Guía Práctica Borrador - Nueva Constitución</title>
      ...
      <section className="pilar">
        <div className="container">
          ...
          <p><strong>Libertad de religión.</strong> Chile es un Estado laico, es decir, no tiene religión o creencia oficial; sino que respeta y garantiza la libertad de religión y de creencias espirituales de todas las personas.</p>

          <p><strong>Libertad de pensamiento.</strong> Se consagra el derecho a la libertad de pensamiento, conciencia, religión y cosmovisión. Este derecho incluye la libertad de profesar y cambiar de religión o creencias y de ejercerlas en espacios públicos y privados.</p>
          ...
          <p><strong>Libertad de expresión.</strong> Se garantiza el derecho a la libertad de expresión y opinión en cualquier forma y por cualquier medio. Este derecho comprende la libertad de buscar, recibir y difundir informaciones e ideas de toda índole.</p>
          
          <p><strong>Libertad de prensa.</strong> El Estado debe respetar la libertad de prensa, promover el pluralismo de los medios de comunicación y la diversidad de información. Se prohíbe la censura previa.</p>

          <p><strong>Libertad de enseñanza.</strong> Se garantizará la libertad de enseñanza y el deber del Estado de respetarla. Esto incluye la libertad de las apoderadas y apoderados a elegir el tipo de educación de las personas a su cargo, respetando el interés superior y la autonomía progresiva de niñas, niños y adolescentes. Asimismo, las y los profesores serán titulares de la libertad de cátedra, mientras lo hagan en el marco de los fines y principios de la educación.</p>

          <p><strong>Libertad de emprender y de desarrollar actividades económicas.</strong> La ley deberá regular la aplicación de este derecho y promover el desarrollo de las pymes (pequeñas y medianas empresas) y la protección de los consumidores. Las prácticas de colusión se declaran contrarias al interés social y la ley deberá establecer las sanciones respectivas.</p>
        </div>
      </section>
