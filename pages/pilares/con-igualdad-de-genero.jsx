...
export default function Home() {
  return (
    <div>
      <Head>
        <title>UN CHILE CON IGUALDAD DE GÉNERO | Guía Práctica Borrador - Nueva Constitución</title>
      ...
      <section className="pilar">
        <div className="container">
          ...
          <p><strong>Derecho a la identidad.</strong> Toda persona tendrá derecho a la identidad, en todas sus dimensiones y manifestaciones, incluyendo las características sexuales, expresiones de género, nombre y orientaciones sexoafectivas. El Estado deberá garantizar el pleno ejercicio de este derecho a través de acciones afirmativas, procedimientos y leyes correspondientes.</p>

          <p><strong>Derechos sexuales y derechos reproductivos.</strong> Se garantizará el ejercicio de los derechos sexuales y reproductivos sin discriminación, con enfoque de género, inclusión y pertinencia cultural, así como el acceso a la información, educación, salud, y a los servicios y prestaciones requeridos para ello. Se asegurará a todas las mujeres y personas con capacidad de gestar, las condiciones para un embarazo, su interrupción voluntaria, parto y maternidad voluntarios y protegidos. También, reconoce que las personas puedan beneficiarse del progreso científico para ejercer estos derechos, siendo la ley la que regule su ejercicio.</p>

          <p><strong>Justicia con enfoque de género.</strong> El Sistema de Justicia deberá adoptar medidas para prevenir, sancionar y erradicar la violencia contra las mujeres, disidencias y diversidades sexuales. </p>
