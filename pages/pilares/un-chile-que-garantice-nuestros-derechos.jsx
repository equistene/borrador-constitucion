    ...
    <div>
      ...
      <section className="pilar">
        <div className="container">
          ...
          <p>Derecho a la vida y a la integridad física y psíquica. Toda persona tiene derecho a la vida. Nadie podrá ser condenado a muerte ni ejecutado.</p>
          ...
          <p>Verdad, justicia, reparación y garantías de no repetición. Las víctimas de graves violaciones a los derechos humanos tienen derecho a la reparación integral.</p>
          ...
          <p>Derecho a la salud. Toda persona tendrá derecho a la salud y bienestar integral, incluyendo su dimensión física y mental. En cuanto a la salud mental, el Estado deberá generar políticas y programas, aumentando progresivamente su financiamiento.</p>
          ...
          <p>Derecho a la muerte digna. La Constitución asegurará el derecho a las personas a tomar decisiones libres e informadas sobre sus cuidados y tratamientos al final de su vida.</p>
          ...
          <p>Reconocimiento del trabajo doméstico y de cuidados. El Estado reconoce que los trabajos domésticos y de cuidados son socialmente necesarios e indispensables para el desarrollo del país y deben ser considerados en la formulación y ejecución de las políticas públicas.</p>

          <p>El Estado promoverá la corresponsabilidad y mecanismos para la distribución de los trabajos domésticos y de cuidados.</p>

          <p>Derecho al trabajo decente. Toda persona tendrá derecho al trabajo y su libre elección. El Estado garantizará el trabajo decente y su protección, condiciones laborales equitativas, a la salud y seguridad, al descanso y al disfrute del tiempo libre.</p>
